...
public interface CourseService {
	...
	List<CourseVO> selectCourseIncludesSearchItem(String item);
	List<CourseVO> selectCourseForMoreAjax(Map<String, Integer> map);
	Map<String, Object> getCoursesByPaging(PagingVO page);
	Map<String, Object> getCourses(PagingVO page);
