...
public interface OrderMapper {
	...
	/* 멘토링 */
	int insertBuyMentroing(OrderVO orderVO);
	int selectDuplicateBuyMentoring(OrderVO orderVO);
	List<OrderVO> selectSaleHistoryAll(String member_id);
	List<OrderVO> insertFreePay(OrderVO orderVO);
	List<OrderVO> selectBuyHistoryAll(String member_id);
	List<OrderVO> selectPurchaseAll(OrderVO orderVO);
	List<OrderVO> selectBuyAll(OrderVO orderVO);
	// admin
	List<OrderVO> selectAllPayList(OrderVO orderVO);
}
