...
public interface MemberMapper {
	...
	// 관리자 회원가입
	public int registerAdmin(MemberVO memberVO);
	//이메일 체크
	...
	//비밀번호 변경을 위해 이메일 확인
	public String selectEmailByMemberID(MemberVO member);
	// 예제 회원 생성
	public int insertSampleMentors(List<MemberVO> mentors);
	public int insertSampleMentees(List<MemberVO> mentees);
