			...
			<div class="container-xl">
				...
				<ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4 web-nav">
					...
					<li class="nav-item"><a class="nav-link" role="button"
						href="${path }/mentoring">멘토링</a></li>

					<li class="nav-item">
						<div class="dropdown-col">
							<a class="nav-link" role="button" href="${path }/community/questions"">커뮤니티</a>
							<div class="dropdown-content-hover">
								<a class="dropdown-item" href="${path }/community/questions">질문&답변</a> <a
									class="dropdown-item" href="${path }/community/chats">자유주제</a> <a
									class="dropdown-item" href="${path }/community/studies">스터디</a> <a
						...
						<div class="dropdown-col">
							...
							<div class="dropdown-content-hover">
								<a class="dropdown-item" href="${path }/review/course">수강평</a> <a
									...
									class="dropdown-item" href="${path }/community/studies">스터디</a> <a
									class="dropdown-item" href="${path }/api/jAPI">채용 정보</a> <a
									class="dropdown-item" href="${path }/api/seoulApi">인프런 채용</a> <a
				...
				<c:if test="${user != null}">
					<div class="header-buttons ms-auto" style="display: flex">
						<button type="button"
							class="btn btn-outline-warning web-btn-header" onclick="location.href='${path}/mypage/applyMentor'">지식 공유 참여</button>
						<c:if test="${user.member_role == '관리자'}">
							<button type="button" class="btn btn-outline-primary"
							onclick="createSampleMembers()">회원 생성</button>
						</c:if>
			...
			<div class="bottom-item">
				<div class="dropup">
					...
					<ul class="dropdown-menu">
						<li><a class="dropdown-item" href="${path }/community/questions">질문 게시판</a></li>
						<li><a class="dropdown-item" href="${path }/review/course">수강평</a></li>
						<li><a class="dropdown-item" href="#">멘토링 후기</a></li>
						<li><a class="dropdown-item" href="${path }/community/studies">스터디</a></li>
						<li><a class="dropdown-item" href="${path}/mypage/applyMentor">지식 공유 참여</a></li>
					</ul>
				</div>
			</div>
		</div>
					...
					<div class="wrap-login100" style="padding: 0 55px 55px 55px;">
						...
						<div class="text-center pt5">
							<span class="txt1"> 비밀번호를 잊으셨나요? </span> <a class="txt2"
								href="${path }/member/findPw" style="font-weight: bold;"> Find Password </a>
						</div>
						<div class="text-center pt5">
		...
		function createSampleMembers(){
			Swal.fire({
				  ...
				  if (result.isConfirmed) {
					$.ajax({
						url: '${path}/member/createSamples',
						type:'post',
						dataTyple:'json',
						success:function(data){
							if(data==true){
								Swal.fire('회원 생성 완료', '', 'success');
							}else{
								Swal.fire('이미 존재합니다.', '', 'error');
							}
						}
					});
